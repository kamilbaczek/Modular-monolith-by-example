...
{
    public sealed class ValuationDeadlineFixedDomainEvent : DomainEventBase
    {
        public ValuationDeadlineFixedDomainEvent(ValuationId valuationId, Deadline deadline)
        {
