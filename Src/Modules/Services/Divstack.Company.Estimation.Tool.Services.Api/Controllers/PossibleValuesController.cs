...
internal sealed class PossibleValuesController : BaseController
{
    ...
    public async Task<ActionResult> CreatePossibleValuesAsync(
    ...
    public async Task<ActionResult> RemovePossibleValuesAsync(Guid serviceId, Guid attributeId, Guid possibleValueId)
    {
