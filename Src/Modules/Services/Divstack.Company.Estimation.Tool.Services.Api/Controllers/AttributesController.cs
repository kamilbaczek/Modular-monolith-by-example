...
internal sealed class AttributesController : BaseController
{
    ...
    public async Task<ActionResult> CreateAttributeAsync([FromBody] CreateAttributeRequest createAttributeRequest)
    {
    ...
    public async Task<ActionResult> RemoveAttributeAsync(Guid serviceId, Guid attributeId)
    {
