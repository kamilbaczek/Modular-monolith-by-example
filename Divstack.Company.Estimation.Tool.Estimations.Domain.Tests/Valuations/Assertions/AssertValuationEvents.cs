...
namespace Divstack.Company.Estimation.Tool.Estimations.Domain.Tests.Valuations.Assertions
{
    internal static class AssertValuationEvents
    {
        internal static void AssertIsCorrect(this ValuationRequestedEvent @event, List<ProductId> productIds, Email email)
        {
