...
namespace Divstack.Company.Estimation.Tool.Estimations.Persistance.Migrations
{
    ...
    [Migration("20210414191957_Create_Valuations")]
    partial class Create_Valuations
    {
                    ...
                    b.OwnsOne("Divstack.Company.Estimation.Tool.Estimations.Domain.Valuations.Enquiry", "Enquiry", b1 =>
                        {
                            ...
                            b1.OwnsMany("Divstack.Company.Estimation.Tool.Estimations.Domain.Valuations.Product", "Products", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier");
