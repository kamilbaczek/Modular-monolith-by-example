...
namespace Divstack.Company.Estimation.Tool.Docs.Architecture.C4.Diagrams
{
    internal static class ComponentsView
    {
        ...
        {
            var bootstraper = webApplication.AddComponent("Bootraper",
            ...
            var productsDal = webApplication.AddComponent("DAL - Products", "Provides data access layer",
            ...
            var usersInfrastrucutre =
                webApplication.AddComponent("Infrastructure - Users", "Provides module skeleton", "C#");
            usersApi.Uses(usersInfrastrucutre, "");
            var usersApplication =
                webApplication.AddComponent("Application - Users", "Run action on bussiness logic (Domain)", "C#");
            ...
            var estimationApi =
                webApplication.AddComponent("Api - Estimation", "Serves API to estimate services", ".Net Core API");
            bootstraper.Uses(estimationApi, "");
            var estimationInfrastrucutre =
                webApplication.AddComponent("Infrastructure - Estimation", "Provides module skeleton", "C#");
            estimationApi.Uses(estimationInfrastrucutre, "");
            var estimationApplication = webApplication.AddComponent("Application - Estimation",
